...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject method takes a block that will be executed for every element in
    # the object you call the method on. The argument is the initial value on
  ...
  def test_all_iteration_methods_work_on_any_collection_not_just_arrays
    ...
    File.open("example_file.txt") do |file|
      upcase_lines = file.map { |line| line.strip.upcase } # .strip removes whitespaces
