...
class AboutRegularExpressions < Neo::Koan
  ...
  # They try to match as much as possible in a string, which might not always
  # be a desired effect
  # ------------------------------------------------------------------
  ...
  def test_slash_d_is_a_shortcut_for_a_digit_character_class
    assert_equal "42", "the number is 42"[/[0123456789]+/] # search for match in digits 1234566789
    assert_equal "42", "the number is 42"[/\d+/] # shortcut for the above
  end
  ...
  # search for matching whitespaces characters - /[ \t\r\n\f]/
  # \t tab \n newline \s space \r carriage return
  ...
  # It matches at a position that is called a "word boundary". This match is
  # zero-length. There are three different positions that qualify as word
  # boundaries:
  ...
  # [] is one action, and  alternation is many
  # ------------------------------------------------------------------
  ...
  # string.scan method returns an array if only a pattern is given
  # if it has a block, then a string is returned
