...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # this second half-full glass to refill your drinking glass. You do this every time you need to
    # refill your glass. The second way you take your half full glass and just refill it with water
    # straight from the tap. At the end of the day, you would have more glasses to clean if you choose
    # to pick a new glass every time you needed to refill your glass.
